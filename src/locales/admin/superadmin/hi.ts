...
export default {
  ...
  project: {
    ...
    admin_help_text:
      "वैकल्पिक: किसी कंपनी का पहला प्रोजेक्ट बनाते समय ही प्रोजेक्ट एडमिन विवरण दें।",
    ...
    admin_required_together:
      "admin_username, admin_password और admin_employee_name तीनों साथ में देने होंगे।",
    company_admin_created:
      "प्रोजेक्ट एडमिन बना दिया गया - यूज़रनेम: {{username}}, आईडी: {{unique_id}}",
  ...
  common_audit: {
    module_filter_label: "मॉड्यूल",
    module_filter_hint: "सिस्टम का कौन सा भाग बदला गया",
    company_filter_label: "कंपनी",
    company_filter_hint: "किसका डेटा बदला गया",
    project_filter_label: "परियोजना",
    project_filter_hint: "परिवर्तन किस परियोजना से संबंधित है",
    company: "कंपनी",
    project: "परियोजना",
    company_filter: "कंपनी द्वारा फ़िल्टर करें",
    project_filter: "परियोजना द्वारा फ़िल्टर करें",
    no_project: "कोई परियोजना नहीं (कंपनी-व्यापी)",
  ...
  user_screen_permission: {
    ...
    permission_exists_body:
      "इस स्टाफ यूज़र प्रकार के लिए अनुमति पहले से मौजूद है। एडिट पर रीडायरेक्ट किया जा रहा है।",
    all: "सभी",
  ...
  staff_creation: {
    ...
    form_subtitle:
      "नया स्टाफ रिकॉर्ड बनाने के लिए आधिकारिक और व्यक्तिगत विवरण भरें।",
    create: "स्टाफ जोड़ें",
    ...
    password_edit_hint:
      "यदि आप पासवर्ड बदलना चाहते हैं तो नया पासवर्ड दर्ज करें।",
  ...
  nav: {
    ...
    complaint_masters: "शिकायत मास्टर",
    complaint_types: "शिकायत प्रकार",
    complaint_desk: "शिकायत डेस्क",
    ...
    statuses: "स्थितियां",
    sources: "स्रोत",
    department_roster: "विभाग रोस्टर",
    supervisor_dashboard: "पर्यवेक्षक डैशबोर्ड",
    my_tasks: "मेरे कार्य",
    sla_rules: "SLA Rules",
    complaints: "शिकायतें",
