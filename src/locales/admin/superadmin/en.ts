...
export default {
  ...
  common_audit: {
    module_filter_label: "Module",
    module_filter_hint: "Which system area was changed",
    company_filter_label: "Company",
    company_filter_hint: "Whose data was changed",
    project_filter_label: "Project",
    project_filter_hint: "Which project the change belongs to",
    company: "Company",
    project: "Project",
    company_filter: "Filter by company",
    project_filter: "Filter by project",
    no_project: "No project (company-wide)",
