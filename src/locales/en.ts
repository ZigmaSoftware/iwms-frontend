  ...
  translation: {
    ...
    dashboard: {
      ...
      alerts: {
        ...
        review: "Review",
        message_route_deviation:
          "Route deviation detected - 2.4km off planned route",
        message_weight_mismatch:
          "Weight mismatch: Expected 2.8T, Logged 3.2T (14% difference)",
        message_missed_pickup: "Missed pickup at location #47",
        message_staff_late_login:
          "Staff late login - Scheduled: 06:00, Actual: 06:42",
    ...
    admin: {
      ...
      nav: {
        ...
        companywise_user_screen_permission:
        ...
        customer_access_configuration: "Customer App Access",
        ...
        complaint_masters: "Complaint Masters",
        ...
        sources: "Sources",
        teams: "Teams",
        department_roster: "Department Roster",
      ...
      project: {
        ...
        admin_help_text:
          "Optional: provide project admin details only when creating the first project for a company.",
        admin_employee_name: "Admin Employee Name",
        admin_username: "Admin Username",
        admin_password: "Admin Password",
        admin_email: "Admin Email",
        admin_required_together:
          "admin_username, admin_password, and admin_employee_name must be provided together.",
        company_admin_created:
          "Project admin created - Username: {{username}}, ID: {{unique_id}}",
      ...
      user_screen_permission: {
        ...
        permission_exists_body:
          "This project already has permissions. Redirecting to Edit.",
        all: "All",
      ...
      staff_access_configuration: {
        ...
        subtitle:
          "Assign a staff member to a project + location scope, and grant a subset of the project's enabled screens/actions",
        ...
        select_project_first:
          "Select a project to load its available screens & actions",
        loading_permissions: "Loading available permissions...",
        no_permissions_enabled:
          "No screens/actions have been enabled for this project yet",
        load_permissions_failed: "Failed to load available permissions",
        selected_summary:
          "{{screens}} screen(s), {{actions}} action(s) selected",
        confirm_delete:
          "This staff member's access configuration will be deleted!",
      ...
      staff_creation: {
        ...
        form_subtitle:
          "Fill in official and personal details to create a new staff record.",
        create: "Add Staff",
      ...
      dashboard_home: {
        ...
        subtitle:
          "Live snapshot of fleet, crew, and citizen services across the corporation.",
        metrics: {
      ...
      reports: {
        ...
        trip_summary: {
          ...
          roster_unavailable:
            "Live vehicle list unavailable. Using fallback list.",
          ...
          error_no_export:
            "No data to export. Try fetching a range with trips first.",
          summary: {
            vehicle_no: "Vehicle No",
            start_km: "Start Km",
            end_km: "End Km",
