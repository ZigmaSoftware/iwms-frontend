...
export function buildNavRouteMap(): RouteEntry[] {
  ...
  _cache = [
    ...
    // SuperAdmin Masters
    {
      ...
      parentNameKey: "admin.nav.superAdmin_masters",
    },
    {
    ...
    // Common Masters
    {
      ...
      parentNameKey: "admin.nav.common_masters",
    },
    {
    ...
    // Administrative / Geographic Hierarchy
    {
      ...
      parentNameKey: "admin.nav.masters",
    },
    {
    ...
    // Waste Types
    {
      ...
      parentNameKey: "admin.nav.wastetype",
    },
    {
    ...
    // Assets
    {
      ...
      parentNameKey: "admin.nav.assets",
    },
    {
    ...
    // Screen Managements
    {
      ...
      parentNameKey: "admin.nav.screenManagements",
    },
    {
    ...
    // Org / Department Setup
    {
      ...
      parentNameKey: "admin.nav.user_creations",
    },
    {
    ...
    // names the screen, and the tab strip on the page shows which tab is open.
    {
      ...
      parentNameKey: "admin.nav.complaint_masters",
    },
    {
      path: `/${encComplaintMastersModule}/${encComplaintCategories}`,
      nameKey: "admin.nav.complaint_types",
      parentNameKey: "admin.nav.complaint_masters",
    },
    {
      path: `/${encComplaintMastersModule}/${encComplaintSubcategories}`,
      nameKey: "admin.nav.complaint_types",
      parentNameKey: "admin.nav.complaint_masters",
    },
    {
      path: `/${encComplaintMastersModule}/${encComplaintSlaRules}`,
      nameKey: "admin.nav.complaint_types",
      parentNameKey: "admin.nav.complaint_masters",
    },
    // Complaint Ticketing
    ...
    // Transport Masters
    {
      ...
      parentNameKey: "admin.nav.transport_masters",
    },
    {
    ...
    {
      path: `/${encTransportMaster}/${encTripPlans}`,
    ...
    // Schedule Setup (split from the legacy "schedule-masters" group)
    {
      ...
      nameKey: "admin.nav.staff_template",
      parentNameKey: "admin.nav.schedule_setup",
    },
    {
    ...
    {
      path: `/${encScheduleOperations}/${encDailyTripCollectionPoint}`,
    ...
    {
      path: `/${encScheduleOperations}/${encSchedulerConfig}`,
    ...
    // Vehicle Tracking
    {
      ...
      parentNameKey: "admin.nav.vehicle_tracking",
    },
    {
    ...
    // Waste Management
    {
      ...
      parentNameKey: "admin.nav.waste_management",
    },
    {
